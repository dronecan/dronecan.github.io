...
will be explained in [the chapter 6 of the specification](/specification/Specification/6._Application_level_functions/)).
...
{% include lightbox.html url="/specification/Specification/figures/transfer_crc_input.png" title="Transfer CRC input" %}
...
(documented in [the chapter 6 of the specification](/specification/Specification/6._Application_level_functions/)).
...
{% include lightbox.html url="/specification/Specification/figures/can_id_format.png" title="CAN ID format" %}
...
{% include lightbox.html url="/specification/Specification/figures/can_payload_format.png" title="CAN payload format" %}
...
{% include lightbox.html url="/specification/Specification/figures/single_frame_transfer.png" title="Single frame transfer" %}

The following figure summarizes the data field format for a multi-frame transfer:

{% include lightbox.html url="/specification/Specification/figures/multi_frame_transfer.png" title="Multi frame transfer" %}
...
The chapter dedicated to [hardware design recommendations](/specification/Specification/8._Hardware_design_recommendations) contains
