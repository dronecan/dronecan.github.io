...
[*data structure description language* (DSDL)](/specification/Specification/3._Data_structure_description_language).
...
the [standard data types and application level functions](/specification/Specification/6._Application_level_functions).

Serialized message and service data structures are exchanged by means of the
[CAN bus transport layer](/specification/Specification/4._CAN_bus_transport_layer), which implements automatic decomposition of long
